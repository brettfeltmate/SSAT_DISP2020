...
SSAT_DISP2020_ind_vars = IndependentVariableSet()
SSAT_DISP2020_ind_vars.add_variable("set_size", int, [8, 12, 16])
SSAT_DISP2020_ind_vars.add_variable("present_absent", str, ["present", "absent"])
...
>> SSAT_DISP2020_ind_vars.add_variable("color", str)
>> SSAT_DISP2020_ind_vars.add_variable("size", float)
>> SSAT_DISP2020_ind_vars.add_variable("active", bool)
>> SSAT_DISP2020_ind_vars.add_variable("count", int)

Finally, we add values to each variable. This can be done one at a time, as in the colors example below:

>> SSAT_DISP2020_ind_vars['color'].add_value("blue")
>> SSAT_DISP2020_ind_vars['color'].add_value("blue")
>> SSAT_DISP2020_ind_vars['color'].add_value("blue")

Or altogether in a comma-separated set, as in the 'count' example:

>> SSAT_DISP2020_ind_vars['count'].add_values(1,2,3,4,5)
...
>> SSAT_DISP2020_ind_vars['size'].add_value(1.0, 2)
>> SSAT_DISP2020_ind_vars['size'].add_value(2.0, 2)
>> SSAT_DISP2020_ind_vars['size'].add_value(5.0)
...
>> SSAT_DISP2020_ind_vars['active'].add_values((True, 5), False)

which is equivalent to:

>> SSAT_DISP2020_ind_vars['active'].add_value(True, 5)
>> SSAT_DISP2020_ind_vars['active'].add_value(False)
...
>> SSAT_DISP2020_ind_vars['size'].enabled = False
...
>> SSAT_DISP2020_ind_vars['size'][1.0].enabled = False
